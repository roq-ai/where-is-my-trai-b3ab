...
function TrainEditPage() {
  ...
  const handleSubmit = async (values: TrainInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateTrainById(id, values);
      mutate(updated);
      resetForm();
      router.push('/trains');
    } catch (error) {
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.current_location}
