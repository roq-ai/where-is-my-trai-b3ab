  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Stay on track with Where Is My Train - Your reliable companion for real-time train location updates and seamless journeys."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/uploads/1413387158190559d80f7/6108b580?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFpbnxlbnwwfHx8fDE2ODk5OTg4MjF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@charles_forerunner?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Charles Forerunner`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Stay on track with Where Is My Train - Your reliable companion for real-time train location updates and seamless journeys.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="End User" type="end-user" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
